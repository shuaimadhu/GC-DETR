...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', '-c', default='/home/rtx4070/DEIM-main/configs/deim_dfine/deim_hgnetv2_l_coco_sea.yml', type=str, )
    parser.add_argument('--resume', '-r', type=str, default='/home/rtx4070/DEIM-main/outputs/FINAL_pufenjie/best_stg2.pth' )
